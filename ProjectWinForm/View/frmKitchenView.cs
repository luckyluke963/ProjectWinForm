    ...
    public partial class frmKitchenView : Form
    {
        ...
        private void GetOrders()
        {
            ...
            for (int i = 0; i < dt1.Rows.Count; i++)
            {
                ...
                string qry2 = @"Select * from Main m
        ...
        private void b_Click(object sender, EventArgs e)
        {
            ...
            if (guna2MessageDialog1.Show("Ban muon xoa không?") == DialogResult.Yes)
            {
                string qry = @"Update Main set status = 'Complete' where MainID = @ID";
